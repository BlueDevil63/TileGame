...
///1. GameManager에서 임시 저장된 플레이어 정보를 로드
///2. 플레이어의 정보를 GUI에 표시
///3. 플레이어 카드 및 아이템을 불러오기
///4. GameManager를 통해서 던전 데이터를 로드
///5. 로드된 데이터를 통해  난이도 1-2->3 순으로 몬스터를 나열 혹은 랜던으로 몬스터 나열
...
///8. 플레이어가 클릭할 버튼을 다시 체크 1~3까지 공격
/// 0 좌 1 중앙 2 우측
